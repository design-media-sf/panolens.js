...
$jscomp.getGlobal=function(d){return"undefined"!=typeof window&&window===d?d:"undefined"!=typeof global&&null!=global?global:d};$jscomp.global=$jscomp.getGlobal(this);$jscomp.ASSUME_ES5=!1;$jscomp.ASSUME_NO_NATIVE_MAP=!1;$jscomp.ASSUME_NO_NATIVE_SET=!1;$jscomp.SIMPLE_FROUND_POLYFILL=!1;$jscomp.defineProperty=$jscomp.ASSUME_ES5||"function"==typeof Object.defineProperties?Object.defineProperty:function(d,c,n){d!=Array.prototype&&d!=Object.prototype&&(d[c]=n.value)};
$jscomp.polyfill=function(d,c,n,v){if(c){n=$jscomp.global;d=d.split(".");for(v=0;v<d.length-1;v++){var p=d[v];p in n||(n[p]={});n=n[p]}d=d[d.length-1];v=n[d];c=c(v);c!=v&&null!=c&&$jscomp.defineProperty(n,d,{configurable:!0,writable:!0,value:c})}};$jscomp.FORCE_POLYFILL_PROMISE=!1;
$jscomp.polyfill("Promise",function(d){function c(){this.batch_=null}function n(c){return c instanceof p?c:new p(function(d,S){d(c)})}if(d&&!$jscomp.FORCE_POLYFILL_PROMISE)return d;c.prototype.asyncExecute=function(c){if(null==this.batch_){this.batch_=[];var d=this;this.asyncExecuteFunction(function(){d.executeBatch_()})}this.batch_.push(c)};var v=$jscomp.global.setTimeout;c.prototype.asyncExecuteFunction=function(c){v(c,0)};c.prototype.executeBatch_=function(){for(;this.batch_&&this.batch_.length;){var c=
this.batch_;this.batch_=[];for(var d=0;d<c.length;++d){var k=c[d];c[d]=null;try{k()}catch(K){this.asyncThrow_(K)}}}this.batch_=null};c.prototype.asyncThrow_=function(c){this.asyncExecuteFunction(function(){throw c;})};var p=function(c){this.state_=0;this.result_=void 0;this.onSettledCallbacks_=[];var d=this.createResolveAndReject_();try{c(d.resolve,d.reject)}catch(k){d.reject(k)}};p.prototype.createResolveAndReject_=function(){function c(c){return function(l){k||(k=!0,c.call(d,l))}}var d=this,k=!1;
return{resolve:c(this.resolveTo_),reject:c(this.reject_)}};p.prototype.resolveTo_=function(c){if(c===this)this.reject_(new TypeError("A Promise cannot resolve to itself"));else if(c instanceof p)this.settleSameAsPromise_(c);else{a:switch(typeof c){case "object":var d=null!=c;break a;case "function":d=!0;break a;default:d=!1}d?this.resolveToNonPromiseObj_(c):this.fulfill_(c)}};p.prototype.resolveToNonPromiseObj_=function(c){var d=void 0;try{d=c.then}catch(k){this.reject_(k);return}"function"==typeof d?
...
this.onSettledCallbacks_=null}};var u=new c;p.prototype.settleSameAsPromise_=function(c){var d=this.createResolveAndReject_();c.callWhenSettled_(d.resolve,d.reject)};p.prototype.settleSameAsThenable_=function(c,d){var l=this.createResolveAndReject_();try{c.call(d,l.resolve,l.reject)}catch(K){l.reject(K)}};p.prototype.then=function(c,d){function l(c,d){return"function"==typeof c?function(d){try{n(c(d))}catch(H){v(H)}}:d}var n,v,u=new p(function(c,d){n=c;v=d});this.callWhenSettled_(l(c,n),l(d,v));return u};
p.prototype.catch=function(c){return this.then(void 0,c)};p.prototype.callWhenSettled_=function(c,d){function l(){switch(n.state_){case 1:c(n.result_);break;case 2:d(n.result_);break;default:throw Error("Unexpected state: "+n.state_);}}var n=this;null==this.onSettledCallbacks_?u.asyncExecute(l):this.onSettledCallbacks_.push(l)};p.resolve=n;p.reject=function(c){return new p(function(d,n){n(c)})};p.race=function(c){return new p(function(d,p){for(var l=$jscomp.makeIterator(c),k=l.next();!k.done;k=l.next())n(k.value).callWhenSettled_(d,
p)})};p.all=function(c){var d=$jscomp.makeIterator(c),k=d.next();return k.done?n([]):new p(function(c,l){function p(d){return function(n){v[d]=n;u--;0==u&&c(v)}}var v=[],u=0;do v.push(void 0),u++,n(k.value).callWhenSettled_(p(v.length-1),l),k=d.next();while(!k.done)})};return p},"es6","es3");
$jscomp.polyfill("Promise.prototype.finally",function(d){return d?d:function(c){return this.then(function(d){return Promise.resolve(c()).then(function(){return d})},function(d){return Promise.resolve(c()).then(function(){throw d;})})}},"es9","es3");$jscomp.SYMBOL_PREFIX="jscomp_symbol_";$jscomp.initSymbol=function(){$jscomp.initSymbol=function(){};$jscomp.global.Symbol||($jscomp.global.Symbol=$jscomp.Symbol)};
$jscomp.SymbolClass=function(d,c){this.$jscomp$symbol$id_=d;$jscomp.defineProperty(this,"description",{configurable:!0,writable:!0,value:c})};$jscomp.SymbolClass.prototype.toString=function(){return this.$jscomp$symbol$id_};$jscomp.Symbol=function(){function d(n){if(this instanceof d)throw new TypeError("Symbol is not a constructor");return new $jscomp.SymbolClass($jscomp.SYMBOL_PREFIX+(n||"")+"_"+c++,n)}var c=0;return d}();
$jscomp.initSymbolIterator=function(){$jscomp.initSymbol();var d=$jscomp.global.Symbol.iterator;d||(d=$jscomp.global.Symbol.iterator=$jscomp.global.Symbol("Symbol.iterator"));"function"!=typeof Array.prototype[d]&&$jscomp.defineProperty(Array.prototype,d,{configurable:!0,writable:!0,value:function(){return $jscomp.iteratorPrototype($jscomp.arrayIteratorImpl(this))}});$jscomp.initSymbolIterator=function(){}};
$jscomp.initSymbolAsyncIterator=function(){$jscomp.initSymbol();var d=$jscomp.global.Symbol.asyncIterator;d||(d=$jscomp.global.Symbol.asyncIterator=$jscomp.global.Symbol("Symbol.asyncIterator"));$jscomp.initSymbolAsyncIterator=function(){}};$jscomp.iteratorPrototype=function(d){$jscomp.initSymbolIterator();d={next:d};d[$jscomp.global.Symbol.iterator]=function(){return this};return d};$jscomp.underscoreProtoCanBeSet=function(){var d={a:!0},c={};try{return c.__proto__=d,c.a}catch(n){}return!1};
...
$jscomp.generator.Context.prototype.enterCatchBlock=function(d){this.catchAddress_=d||0;d=this.abruptCompletion_.exception;this.abruptCompletion_=null;return d};$jscomp.generator.Context.prototype.enterFinallyBlock=function(d,c,n){n?this.finallyContexts_[n]=this.abruptCompletion_:this.finallyContexts_=[this.abruptCompletion_];this.catchAddress_=d||0;this.finallyAddress_=c||0};
...
$jscomp.generator.Engine_.prototype.yieldAllStep_=function(d,c,n){try{var v=d.call(this.context_.yieldAllIterator_,c);$jscomp.generator.ensureIteratorResultIsObject_(v);if(!v.done)return this.context_.stop_(),v;var p=v.value}catch(u){return this.context_.yieldAllIterator_=null,this.context_.throw_(u),this.nextStep_()}this.context_.yieldAllIterator_=null;n.call(this.context_,p);return this.nextStep_()};
...
500;this.position.z=-10;this.center.set(.5,.5);this.scale.set(.5,.5,1);this.callback=this.timerId=this.startTimestamp=null;this.frustumCulled=!1;this.updateCanvasArcByProgress(0)}function u(a,b,e){a=void 0===a?300:a;b=b||A.Info;c.Sprite.call(this);this.type="infospot";this.animated=void 0!==e?e:!0;this.frustumCulled=this.isHovering=!1;this.cursorStyle=this.toPanorama=this.element=null;this.mode=y.NORMAL;this.scale.set(a,a,1);this.rotation.y=Math.PI;this.container=null;this.originalRaycast=this.raycast;
this.HANDLER_FOCUS=null;this.material.side=c.DoubleSide;this.material.depthTest=!1;this.material.transparent=!0;this.material.opacity=0;this.scaleUpAnimation=new t.Tween;this.scaleDownAnimation=new t.Tween;e=function(b){if(this.material){var f=b.image.width/b.image.height,e=new c.Vector3;b.image.width=b.image.naturalWidth||64;b.image.height=b.image.naturalHeight||64;this.scale.set(f*a,a,1);e.copy(this.scale);this.scaleUpAnimation=(new t.Tween(this.scale)).to({x:1.3*e.x,y:1.3*e.y},500).easing(t.Easing.Elastic.Out);
this.scaleDownAnimation=(new t.Tween(this.scale)).to({x:e.x,y:e.y},500).easing(t.Easing.Elastic.Out);this.material.map=b;this.material.needsUpdate=!0}}.bind(this);this.showAnimation=(new t.Tween(this.material)).to({opacity:1},500).onStart(this.enableRaycast.bind(this,!0)).easing(t.Easing.Quartic.Out);this.hideAnimation=(new t.Tween(this.material)).to({opacity:0},500).onStart(this.enableRaycast.bind(this,!1)).easing(t.Easing.Quartic.Out);this.addEventListener("click",this.onClick);this.addEventListener("hover",
...
c.EventDispatcher.call(this);this.DEFAULT_TRANSITION="all 0.27s ease";this.TOUCH_ENABLED=!!("ontouchstart"in window||window.DocumentTouch&&document instanceof DocumentTouch);this.PREVENT_EVENT_HANDLER=function(a){a.preventDefault();a.stopPropagation()};this.container=a;this.mask=this.activeSubMenu=this.activeMainItem=this.mainMenu=this.settingElement=this.videoElement=this.fullscreenElement=this.barElement=null}function l(){this.edgeLength=1E4;c.Mesh.call(this,this.createGeometry(this.edgeLength),
this.createMaterial());this.type="panorama";this.ImageQualityLow=1;this.ImageQualityFair=2;this.ImageQualityMedium=3;this.ImageQualityHigh=4;this.ImageQualitySuperHigh=5;this.animationDuration=1E3;this.defaultInfospotSize=350;this.container=void 0;this.loaded=!1;this.linkedSpots=[];this.isInfospotVisible=!1;this.linkingImageScale=this.linkingImageURL=void 0;this.renderOrder=-1;this.active=this.visible=!1;this.infospotAnimation=(new t.Tween(this)).to({},this.animationDuration/2);this.addEventListener(g.CONTAINER,
this.setContainer.bind(this));this.addEventListener("click",this.onClick.bind(this));this.setupTransitions()}function k(a){l.call(this);this.src=a;this.type="image_panorama"}function K(){l.call(this);this.type="empty_panorama"}function U(a){a=void 0===a?[]:a;l.call(this);this.geometry.deleteAttribute("normal");this.geometry.deleteAttribute("uv");this.images=a;this.type="cube_panorama"}function ea(){for(var a=[],b=0;6>b;b++)a.push(A.WhiteTile);U.call(this,a);this.type="basic_panorama"}function B(a,
b){b=void 0===b?{}:b;l.call(this);this.src=a;this.options=Object.assign({videoElement:document.createElement("video"),loop:!0,muted:!0,autoplay:!1,playsinline:!0,crossOrigin:"anonymous"},b);this.videoElement=this.options.videoElement;this.videoProgress=0;this.type="video_panorama";this.addEventListener(g.LEAVE,this.pauseVideo.bind(this));this.addEventListener(g.ENTER_FADE_START,this.resumeVideoProgress.bind(this));this.addEventListener("video-toggle",this.toggleVideo.bind(this));this.addEventListener("video-time",
...
var b;try{var e=document.createElement("canvas");(b=e.getContext("experimental-webgl"))||(b=e.getContext("webgl"))}catch(f){}this.maxW=Math.max(b.getParameter(b.MAX_TEXTURE_SIZE),this.maxW);this.maxH=Math.max(b.getParameter(b.MAX_TEXTURE_SIZE),this.maxH)}function da(a,b){k.call(this);this.panoId=a;this.gsvLoader=null;this.loadRequested=!1;this.setupGoogleMapAPI(b);this.type="google_streetview_panorama"}function H(a,b){"image"===(void 0===a?"image":a)&&k.call(this,b);this.EPS=1E-6;this.frameId=null;
this.dragging=!1;this.userMouse=new c.Vector2;this.quatA=new c.Quaternion;this.quatB=new c.Quaternion;this.quatCur=new c.Quaternion;this.quatSlerp=new c.Quaternion;this.vectorX=new c.Vector3(1,0,0);this.vectorY=new c.Vector3(0,1,0);this.type="little_planet";this.addEventListener(g.WIDNOW_RESIZE,this.onWindowResize)}function aa(a){H.call(this,"image",a);this.type="image_little_planet"}function X(a){l.call(this);this.media=new n(a);this.type="camera_panorama";this.addEventListener(g.ENTER,this.start.bind(this));
this.addEventListener(g.LEAVE,this.stop.bind(this));this.addEventListener(g.CONTAINER,this.onPanolensContainer.bind(this));this.addEventListener("panolens-scene",this.onPanolensScene.bind(this))}function P(a,b){b=void 0===b?new v:b;k.call(this,a);this.stereo=b;this.type="stereo_image_panorama"}function Q(a,b,e){b=void 0===b?{}:b;e=void 0===e?new v:e;B.call(this,a,b);this.stereo=e;this.type="stereo_video_panorama"}function wa(a,b,e,f){function c(){k=Q.addSourceBuffer('video/mp4; codecs="avc1.640033"');
k.mode="sequence"}function d(){L(O,{responseType:"text",onreadystatechange:function(a){if((a=a.target)&&a.readyState==a.DONE){a=(new DOMParser).parseFromString(a.response,"text/xml",0);try{a.querySelectorAll("Representation"),t=1,v=a.querySelectorAll("SegmentURL"),fa=a.querySelectorAll("Initialization"),z.frameCount=v.length}catch(xa){console.log(xa)}y=D.allow_streaming?Math.min(60,z.frameCount):z.frameCount;Z(V)}}})}function q(a,b){E=ha.length;H=B=0;var c=8;ka&&(c=4);for(b=0;b<c;b++)G(a,y,function(){ba||
(e(r,D),ba=!0);for(var b=0;b<c;b++)G(a,E,function(){f(r,D)})})}function G(a,b,f){setTimeout(w,0,a,b,f)}function w(a,b,f){var e,c,m,d,F,h,G;return $jscomp.asyncExecutePromiseGeneratorProgram(function(q){switch(q.nextAddress){case 1:if(!(C<b)){q.jumpTo(3);break}e=0;c=!1;m=ha[B++];C++;case 4:if(!(3>e)||c){q.jumpTo(1);break}d=new Headers;d.append("Range",m.content);d.append("cache-control","no-store");d.append("pragma","no-cache");d.append("cache-control","no-cache");q.setCatchFinallyBlocks(6,7);return q.yield(fetch(a,
{headers:d,method:"GET"}),9);case 9:return F=q.yieldResult,q.yield(F.arrayBuffer(),10);case 10:h=q.yieldResult,x[m.index]=h,H++,c=!0;case 7:q.enterFinallyBlock();q.leaveFinallyBlock(4);break;case 6:G=q.enterCatchBlock();console.log("exception during chunk download, retrying",++e,G);e++;q.jumpTo(7);break;case 3:H===b&&f(),q.jumpToEnd()}})}function g(){r.removeEventListener("canplay",R,!1);r.currentTime=z.currentIndex}function R(){r.removeEventListener("loadeddata",g,!1);r.currentTime=z.currentIndex}
function h(){r.currentTime=z.currentIndex;ca=ba=!0;e(r,D);f(r,D);r.removeEventListener("loadeddata",g,!1);r.removeEventListener("canplay",R,!1);r.removeEventListener("timeupdate",h,!1)}function L(a,b){if(null!=a&&""!==a){var f=new XMLHttpRequest;f.open("GET",a,!0);b&&(f.responseType=b.responseType,b.onreadystatechange&&(f.onreadystatechange=b.onreadystatechange.bind(f)),b.onload&&(f.onload=b.onload));f.addEventListener("error",function(a){console.log("Error: "+a+" Could not load url.")},!1);f.send();
return f}}function l(a,b,f,e,c){return{header:"Range",content:"bytes="+a.getAttribute("mediaRange").toString(),index:b,countPosition:f,firstPass:e,firstPassCompleteIndex:c}}function n(a,b,f,e){var c=[],m=0;if(void 0===e?0:e){for(b=0;b<a.length;b++)c.push(l(a[b],b,!1));return c}e=parseInt(Math.round(a.length/b),10);var d=Math.ceil(a.length/b);d=b+d;for(b=0;b<d;b++)a[b*e]&&(c.push(l(a[b*e],b*e,m++,!0,d)),f.push(b*e));d=c.length;for(b=0;b<c.length;b++)c[b].firstPassCompleteIndex=d;f=e;m=0;for(e=Math.floor(e/
2);1<e;e=Math.floor(e/2)){for(b=0;b<a.length/f;b++)a[e+b*f]&&c.push(l(a[e+b*f],e+b*f,m++,!1,d));f=Math.floor(e/2)}f=[];for(b=0;b<c.length;b++)f[c[b].index]=c[b].index;for(b=0;b<a.length;b++)f[b]||c.push(l(a[b],b,m++,!1,d));a=function(a,b){return a.filter(function(a,f,e){return e.map(function(a){return a[b]}).indexOf(a[b])===f})}(c,"index");c=[];f=[];return a}function p(a){return new Uint8Array([(a&4278190080)>>24,(a&16711680)>>16,(a&65280)>>8,a&255])}var z=this,k,t,v=[],r=document.createElement("video"),
u=[],y,A,ka,E,B,H,fa=[],M=-1,ha,x=[],C=0,K=0,ba,D={},O,V,I,N,ia,la,J,S=[112,97,115,112],U=[116,107,104,100],ca;navigator.userAgent.match(/Android/i)?ka=!0:navigator.userAgent.match(/iPhone|iPad|iPod/i)&&(A=!0);if(/Chrome/i.test(navigator.userAgent.toLowerCase())||/Chrome WebView/i.test(navigator.userAgent.toLowerCase())||/Chromium/i.test(navigator.userAgent.toLowerCase()))var W=!0;else if(/Firefox/i.test(navigator.userAgent.toLowerCase())||/Supermedium/i.test(navigator.userAgent.toLowerCase())){var P=
!0;ka||(W=!0)}else/Safari/i.test(navigator.userAgent.toLowerCase())&&/Chrome/i.test(navigator.userAgent.toLowerCase());if(W){var Q=new MediaSource;r.src=window.URL.createObjectURL(Q);r.preload="auto";Q.addEventListener("sourceopen",c)}else r.setAttribute("playsinline",""),r.muted=!0,r.autoplay=!0;fetch("https://my.panomoments.com/sdk/moment",{method:"POST",body:"private_api_key="+a.private_api_key+"&public_api_key="+a.public_api_key+"&moment_id="+a.moment_id+"&variation="+a.variation+"&sdk_client_type=web",
headers:{"Content-Type":"application/x-www-form-urlencoded"}}).then(function(a){return a.json()}).then(function(a){D=a;O=D.web_mpd_url;V=D.web_video_url;d()});this.frameCount=this.currentIndex=0;this.render=function(a){if(ba){N=a/z.frameCount*360;ia=360/z.frameCount;D.clockwise?0>N&&(N=360+N):(N=-N,N=540+N);N%=360;I=parseInt(Math.round(N/ia),10);if(I==z.frameCount&&D.moment_type)I=z.frameCount-1;else if(I==z.frameCount&&!D.moment_type||!I)I=0;if(z.textureReady()&&M!=I){if(W){if(0==ha.length||x[I])var f=
I;else{var e=!1,c=!1;for(a=I;!e&&a<z.frameCount;)x[a]?(e=!0,f=a):a++;for(a=I;!c&&0<=a;)if(x[a]){c=!0;var m=a}else a--;f||(f=z.frameCount);f=Math.abs(I-f)<=Math.abs(I-m)&&f==z.frameCount?0:Math.abs(I-f)<=Math.abs(I-m)?f:m}f||(f=0)}else f=I;z.currentIndex=f;f=z.currentIndex;la!=f&&((la=f,W)?x[f]&&k&&!k.updating&&ba&&(f<z.frameCount?(r.currentTime+=1/t,k.timestampOffset=r.currentTime,D.aligned?k.appendBuffer(x[f]):k.appendBuffer(x[(f+framePadding)%z.frameCount])):console.log("Invalid Index")):A||P?D.aligned?
r.fastSeek(1*f/t):r.fastSeek((f+framePadding)%z.frameCount/t):r.currentTime=1*f/t);M=I}b(r,D)}else console.log("Render called before download is ready. Wait for Ready callback before calling Render.")};this.dispose=function(){r.src="";t=k=f=e=b=r=null;v=[];Q=null;u.splice(0,u.length);H=B=E=P=W=ka=A=y=null;fa=[];fa.splice(0,fa.length);ha=M=null;x.splice(0,x.length);P=ba=K=C=null;D={};ca=J=la=ia=N=I=V=O=null;console.log("PanoMoment Web SDK Disposed")};this.textureReady=function(){return!W&&1==ca&&r.readyState===
r.HAVE_ENOUGH_DATA||W&&(P&&3<=r.readyState||r.readyState===r.HAVE_ENOUGH_DATA)?!0:!1};var Z=function(a){var b,f,e,c,m,d,F,h,q,G,w,g,N,L,r,l,R,sa;return $jscomp.asyncExecutePromiseGeneratorProgram(function(k){switch(k.nextAddress){case 1:b=new Headers,f="bytes="+fa[0].getAttribute("range").toString(),-1<a.indexOf("https://data.panomoments.com/")?a=a.replace(/data.panomoments.com/i,"s3.amazonaws.com/data.panomoments.com"):-1<a.indexOf("https://staging-data.panomoments.com/")&&(a=a.replace(/staging-data.panomoments.com/i,
"s3.amazonaws.com/staging-data.panomoments.com")),b.append("Range",f),e=0,c=!1;case 2:if(!(5>e)||c){k.jumpTo(0);break}k.setCatchFinallyBlocks(4);return k.yield(fetch(a,{headers:b,method:"GET"}),6);case 6:return m=k.yieldResult,k.yield(m.arrayBuffer(),7);case 7:d=k.yieldResult;J=new Uint8Array(d);F=ja(J,S);h=ja(J,U);0<h&&0<F&&(q=new ArrayBuffer(2),G=new DataView(q),G.setInt8(0,J[h+80]),G.setInt8(1,J[h+81]),w=G.getUint16(0),w=w.toString(),g=new ArrayBuffer(2),N=new DataView(g),N.setInt8(0,J[h+82]),
N.setInt8(1,J[h+83]),L=parseFloat(N.getUint16(0))/Math.pow(2,16),L=L.toString().substr(1),r=w.toString()+L.toString(),l=parseFloat(J[F+7])/parseFloat(J[F+11]),R=Math.round(parseFloat(r)/l),new Uint8Array([p(R)[2],p(R)[3]]),J[h+80]=p(R)[2],J[h+81]=p(R)[3],J[h+82]=[0],J[F+7]=[1],J[F+11]=[1]);da(V);c=!0;k.leaveTryBlock(2);break;case 4:sa=k.enterCatchBlock(),console.log("failure during init",e,sa),e++,k.jumpTo(2)}})},T=function(a){(!k||k&&k.updating)&&0==K?(console.log("Buffer not ready. Retrying in 1 second."),
setTimeout(function(){T(a)},1E3)):a&&k&&!k.updating&&0==K&&(r.currentTime+=1/t,k.timestampOffset=r.currentTime,k.appendBuffer(a),K++,setTimeout(function(){T(a)},500))},da=function(a){var f,e,c,m,d,F,h,q,G,w;return $jscomp.asyncExecutePromiseGeneratorProgram(function(g){switch(g.nextAddress){case 1:f=new Headers,e=D.start_frame+90,ia=360/z.frameCount,D.clockwise||(e=-e),0>e&&(e=360+e),z.currentIndex=parseInt(Math.round(e/ia),10),c="bytes="+v[z.currentIndex].getAttribute("mediaRange").toString(),f.append("Range",
c),-1<a.indexOf("https://data.panomoments.com/")?a=a.replace(/data.panomoments.com/i,"s3.amazonaws.com/data.panomoments.com"):-1<a.indexOf("https://staging-data.panomoments.com/")&&(a=a.replace(/staging-data.panomoments.com/i,"s3.amazonaws.com/staging-data.panomoments.com")),m=0,d=!1;case 2:if(!(5>m)||d){g.jumpTo(0);break}g.setCatchFinallyBlocks(4);return g.yield(fetch(a,{headers:f,method:"GET"}),6);case 6:return F=g.yieldResult,g.yield(F.arrayBuffer(),7);case 7:h=g.yieldResult;q=new Uint8Array(h);
G=new Int8Array(J.length+q.length);G.set(J);G.set(q,J.length);W?(x[z.currentIndex]=h,T(G),b(r,D),ha=n(v,y,u,!1)):(r.addEventListener("loadeddata",X),r.addEventListener("canplay",Y),r.src=window.URL.createObjectURL(new Blob([G],{type:"video/mp4"})),r.pause());window.self!==window.top?ea(a):aa(a);d=!0;g.leaveTryBlock(2);break;case 4:w=g.enterCatchBlock(),console.log("failure during first frame download",m,w),m++,g.jumpTo(2)}})},ea=function(a){var b=document.createElement("div");b.style.margin="1px";
b.style.height="100%";b.style.width="100%";b.style.pointerEvents="none";b.style.zIndex=-1;b.style.position="fixed";b.style.top=0;document.body.appendChild(b);var f=new IntersectionObserver(function(a){a[0].isIntersecting&&(f.disconnect(),document.body.removeChild(b),aa())});f.observe(b)},aa=function(a){W?q(V):fetch(V).then(function(a){a.arrayBuffer().then(function(a){ca=!1;r.addEventListener("loadeddata",g,!1);r.addEventListener("canplay",R,!1);r.addEventListener("timeupdate",h,!1);a=new Uint8Array(a);
var b=ja(J,S),f=ja(J,U);if(0<f&&0<b){var e=new ArrayBuffer(2);e=new DataView(e);e.setInt8(0,a[f+80]);e.setInt8(1,a[f+81]);e=e.getUint16(0);e=e.toString();var c=new ArrayBuffer(2);c=new DataView(c);c.setInt8(0,a[f+82]);c.setInt8(1,a[f+83]);c=parseFloat(c.getUint16(0))/Math.pow(2,16);c=c.toString().substr(1);e=e.toString()+c.toString();c=parseFloat(a[b+7])/parseFloat(a[b+11]);e=Math.round(parseFloat(e)/c);a[f+80]=p(e)[2];a[f+81]=p(e)[3];a[f+82]=[0];a[b+7]=[1];a[b+11]=[1]}r.src=window.URL.createObjectURL(new Blob([a],
{type:"video/mp4"}));r.pause()})})},X=function(){ca=!0;r.removeEventListener("loadeddata",X);r.removeEventListener("canplay",Y);b(r,D)},Y=function(){ca=!0;r.removeEventListener("canplay",Y);r.removeEventListener("loadeddata",X);b(r,D)},ja=function(a,b,f){f=a.indexOf(b[0],f||0);if(1===b.length||-1===f)return f;for(var e=f,c=0;c<b.length&&e<a.length;e++,c++)if(a[e]!==b[c])return ja(J,b,f+1);return e===f+b.length?f:-1}}function E(a){var b=this;l.call(this);this.identifier=a;this.momentData=this.PanoMoments=
...
this.addEventListener(g.FADE_IN,function(){return b.enter()});this.addEventListener(g.LEAVE_COMPLETE,function(){return b.leave()});this.addEventListener(g.LOAD_START,function(){return b.disableControl()});this.addEventListener(g.PANOMOMENT.READY,function(){return b.enableControl()})}function Y(a){var b=this;E.call(this,a);this.viewerResetControlLimits=function(){return b.resetControlLimits(!1)}}function ma(a){E.call(this,a);this.scale2D=new c.Vector2(1,1)}function na(a,b){function e(a){if(!1!==h.enabled){a.preventDefault();
if(a.button===h.mouseButtons.ORBIT){if(!0===h.noRotate)return;C=x.ROTATE;L.set(a.clientX,a.clientY)}else if(a.button===h.mouseButtons.ZOOM){if(!0===h.noZoom)return;C=x.DOLLY;r.set(a.clientX,a.clientY)}else if(a.button===h.mouseButtons.PAN){if(!0===h.noPan)return;C=x.PAN;p.set(a.clientX,a.clientY)}C!==x.NONE&&(document.addEventListener("mousemove",f,!1),document.addEventListener("mouseup",m,!1),h.dispatchEvent(T))}}function f(a){if(!1!==h.enabled){a.preventDefault();var b=h.domElement===document?h.domElement.body:
h.domElement;C===x.ROTATE?!0!==h.noRotate&&(l.set(a.clientX,a.clientY),n.subVectors(l,L),0==L.x&&0==L.y?(L.set(l.x,l.y),n.subVectors(l,L)):(h.rotateLeft(2*Math.PI*n.x/b.clientHeight*h.rotateSpeed),h.rotateUp(2*Math.PI*n.y/b.clientHeight*h.rotateSpeed),L.copy(l))):C===x.DOLLY?!0!==h.noZoom&&(y.set(a.clientX,a.clientY),A.subVectors(y,r),0<A.y?h.dollyIn():0>A.y&&h.dollyOut(),r.copy(y)):C===x.PAN&&!0!==h.noPan&&(z.set(a.clientX,a.clientY),t.subVectors(z,p),h.pan(t.x,t.y),p.copy(z))}}function m(){!1!==
h.enabled&&(document.removeEventListener("mousemove",f,!1),document.removeEventListener("mouseup",m,!1),h.dispatchEvent(V),C=x.NONE)}function d(a){if(!1!==h.enabled&&!0!==h.noZoom&&C===x.NONE){a.preventDefault();a.stopPropagation();var b=0;void 0!==a.wheelDelta?b=a.wheelDelta:void 0!==a.detail&&(b=-a.detail);0<b?(h.object.fov=h.object.fov<h.maxFov?h.object.fov+1:h.maxFov,h.object.updateProjectionMatrix()):0>b&&(h.object.fov=h.object.fov>h.minFov?h.object.fov-1:h.minFov,h.object.updateProjectionMatrix());
h.dispatchEvent(D);h.dispatchEvent(T);h.dispatchEvent(V);h.dispatchEvent(I)}}function q(a){}function G(a){if(!1!==h.enabled&&!0!==h.noKeys&&!0!==h.noRotate&&!h.autoRotate){var b=h.momentum&&!h.autoRotate?h.momentumKeydownFactor*h.momentumFactor:h.momentumKeydownFactor;switch(a.keyCode){case h.keys.UP:h.rotateUp(h.rotateSpeed*b);break;case h.keys.BOTTOM:h.rotateUp(-h.rotateSpeed*b);break;case h.keys.LEFT:h.rotateLeft(h.rotateSpeed*b);break;case h.keys.RIGHT:h.rotateLeft(-h.rotateSpeed*b)}}}function g(a){if(!1!==
h.enabled){switch(a.touches.length){case 1:if(!0===h.noRotate)return;C=x.TOUCH_ROTATE;L.set(a.touches[0].pageX,a.touches[0].pageY);break;case 2:if(!0===h.noZoom)return;C=x.TOUCH_DOLLY;var b=a.touches[0].pageX-a.touches[1].pageX;a=a.touches[0].pageY-a.touches[1].pageY;r.set(0,Math.sqrt(b*b+a*a));break;case 3:if(!0===h.noPan)return;C=x.TOUCH_PAN;p.set(a.touches[0].pageX,a.touches[0].pageY);break;default:C=x.NONE}C!==x.NONE&&h.dispatchEvent(T)}}function k(a){if(!1!==h.enabled){a.preventDefault();a.stopPropagation();
var b=h.domElement===document?h.domElement.body:h.domElement;switch(a.touches.length){case 1:if(!0===h.noRotate)break;if(C!==x.TOUCH_ROTATE)break;l.set(a.touches[0].pageX,a.touches[0].pageY);n.subVectors(l,L);h.rotateLeft(2*Math.PI*n.x/b.clientHeight*h.rotateSpeed);h.rotateUp(2*Math.PI*n.y/b.clientHeight*h.rotateSpeed);L.copy(l);break;case 2:if(!0===h.noZoom)break;if(C!==x.TOUCH_DOLLY)break;b=a.touches[0].pageX-a.touches[1].pageX;a=a.touches[0].pageY-a.touches[1].pageY;y.set(0,Math.sqrt(b*b+a*a));
A.subVectors(y,r);0>A.y?(h.object.fov=h.object.fov<h.maxFov?h.object.fov+1:h.maxFov,h.object.updateProjectionMatrix()):0<A.y&&(h.object.fov=h.object.fov>h.minFov?h.object.fov-1:h.minFov,h.object.updateProjectionMatrix());r.copy(y);h.dispatchEvent(D);h.dispatchEvent(I);break;case 3:if(!0===h.noPan)break;if(C!==x.TOUCH_PAN)break;z.set(a.touches[0].pageX,a.touches[0].pageY);t.subVectors(z,p);h.pan(t.x,t.y);p.copy(z);break;default:C=x.NONE}}}function R(){!1!==h.enabled&&(h.dispatchEvent(V),C=x.NONE)}
...
this.dampingFactor=.9;this.speedLimit=Number.MAX_VALUE;this.enableDamping=!0;this.minFov=30;this.maxFov=120;this.minAzimuthAngle=-Infinity;this.maxAzimuthAngle=Infinity;this.noKeys=!1;this.keys={LEFT:37,UP:38,RIGHT:39,BOTTOM:40};this.mouseButtons={ORBIT:c.MOUSE.LEFT,ZOOM:c.MOUSE.MIDDLE,PAN:c.MOUSE.RIGHT};var h=this,L=new c.Vector2,l=new c.Vector2,n=new c.Vector2,p=new c.Vector2,z=new c.Vector2,t=new c.Vector2,v=new c.Vector3,u=new c.Vector3,r=new c.Vector2,y=new c.Vector2,A=new c.Vector2,E=0,B=0,
H=0,K=0,M=1,O=new c.Vector3,P=new c.Vector3,Q=new c.Quaternion,x={NONE:-1,ROTATE:0,DOLLY:1,PAN:2,TOUCH_ROTATE:3,TOUCH_DOLLY:4,TOUCH_PAN:5},C=x.NONE;this.target0=this.target.clone();this.position0=this.object.position.clone();this.zoom0=this.object.zoom;var S=(new c.Quaternion).setFromUnitVectors(a.up,new c.Vector3(0,1,0)),U=S.clone().inverse(),D={type:"change"},T={type:"start"},V={type:"end"},I={type:"fov"};this.setLastQuaternion=function(a){Q.copy(a);h.object.quaternion.copy(a)};this.getLastPosition=
function(){return P};this.rotateLeft=function(a){void 0===a&&(a=2*Math.PI/60/60*h.autoRotateSpeed);a=this.momentum&&!this.autoRotate?a/=this.momentumFactor:a;K-=a};this.rotateUp=function(a){void 0===a&&(a=2*Math.PI/60/60*h.autoRotateSpeed);a=this.momentum&&!this.autoRotate?a/=this.momentumFactor:a;H-=a};this.rotateLeftStatic=function(a){this.enableDamping=!1;K-=a;this.update();this.enableDamping=!0};this.rotateUpStatic=function(a){this.enableDamping=!1;H-=a;this.update();this.enableDamping=!0};this.panLeft=
function(a){var b=this.object.matrix.elements;v.set(b[0],b[1],b[2]);v.multiplyScalar(-a);O.add(v)};this.panUp=function(a){var b=this.object.matrix.elements;v.set(b[4],b[5],b[6]);v.multiplyScalar(a);O.add(v)};this.pan=function(a,b){var f=h.domElement===document?h.domElement.body:h.domElement;if(h.object instanceof c.PerspectiveCamera){var e=h.object.position.clone().sub(h.target).length();e*=Math.tan(h.object.fov/2*Math.PI/180);h.panLeft(2*a*e/f.clientHeight);h.panUp(2*b*e/f.clientHeight)}else h.object instanceof
c.OrthographicCamera?(h.panLeft(a*(h.object.right-h.object.left)/f.clientWidth),h.panUp(b*(h.object.top-h.object.bottom)/f.clientHeight)):console.warn("WARNING: OrbitControls.js encountered an unknown camera type - pan disabled.")};this.dollyIn=function(a){void 0===a&&(a=Math.pow(.95,h.zoomSpeed));h.object instanceof c.PerspectiveCamera?M/=a:h.object instanceof c.OrthographicCamera?(h.object.zoom=Math.max(this.minZoom,Math.min(this.maxZoom,this.object.zoom*a)),h.object.updateProjectionMatrix(),h.dispatchEvent(D)):
console.warn("WARNING: OrbitControls.js encountered an unknown camera type - dolly/zoom disabled.")};this.dollyOut=function(a){void 0===a&&(a=Math.pow(.95,h.zoomSpeed));h.object instanceof c.PerspectiveCamera?M*=a:h.object instanceof c.OrthographicCamera?(h.object.zoom=Math.max(this.minZoom,Math.min(this.maxZoom,this.object.zoom/a)),h.object.updateProjectionMatrix(),h.dispatchEvent(D)):console.warn("WARNING: OrbitControls.js encountered an unknown camera type - dolly/zoom disabled.")};this.update=
function(a){var b=this.object.position;u.copy(b).sub(this.target);u.applyQuaternion(S);E=Math.atan2(u.x,u.z);B=Math.atan2(Math.sqrt(u.x*u.x+u.z*u.z),u.y);this.autoRotate&&C===x.NONE&&this.rotateLeft(2*Math.PI/60/60*h.autoRotateSpeed);!0===this.enableDamping&&this.speedLimit!==Number.MAX_VALUE&&(K=c.Math.clamp(K,-this.speedLimit,this.speedLimit),H=c.Math.clamp(H,-this.speedLimit,this.speedLimit));E+=K;B+=H;E=Math.max(this.minAzimuthAngle,Math.min(this.maxAzimuthAngle,E));B=Math.max(this.minPolarAngle,
Math.min(this.maxPolarAngle,B));B=Math.max(1E-7,Math.min(Math.PI-1E-7,B));var f=u.length()*M;f=Math.max(this.minDistance,Math.min(this.maxDistance,f));this.target.add(O);u.x=f*Math.sin(B)*Math.sin(E);u.y=f*Math.cos(B);u.z=f*Math.sin(B)*Math.cos(E);u.applyQuaternion(U);b.copy(this.target).add(u);this.object.lookAt(this.target);h.spherical.set(f,B,E);this.autoRotate||!0!==this.enableDamping||(!this.momentum||C!==x.ROTATE&&C!==x.TOUCH_ROTATE)&&C!==x.NONE?H=K=0:(K*=this.dampingFactor,H*=this.dampingFactor);
M=1;O.set(0,0,0);if(1E-7<P.distanceToSquared(this.object.position)||1E-7<8*(1-Q.dot(this.object.quaternion)))!0!==a&&this.dispatchEvent(D),P.copy(this.object.position),Q.copy(this.object.quaternion)};this.reset=function(){C=x.NONE;this.target.copy(this.target0);this.object.position.copy(this.position0);this.object.zoom=this.zoom0;this.object.updateProjectionMatrix();this.dispatchEvent(D);this.update()};this.getPolarAngle=function(){return B};this.getAzimuthalAngle=function(){return E};this.dispose=
function(){this.domElement.removeEventListener("mousedown",e);this.domElement.removeEventListener("mousewheel",d);this.domElement.removeEventListener("DOMMouseScroll",d);this.domElement.removeEventListener("touchstart",g);this.domElement.removeEventListener("touchend",R);this.domElement.removeEventListener("touchmove",k);window.removeEventListener("keyup",q);window.removeEventListener("keydown",G)};this.domElement.addEventListener("mousedown",e,{passive:!1});this.domElement.addEventListener("mousewheel",
d,{passive:!1});this.domElement.addEventListener("DOMMouseScroll",d,{passive:!1});this.domElement.addEventListener("touchstart",g,{passive:!1});this.domElement.addEventListener("touchend",R,{passive:!1});this.domElement.addEventListener("touchmove",k,{passive:!1});window.addEventListener("keyup",q,{passive:!1});window.addEventListener("keydown",G,{passive:!1});this.update()}function oa(a){var b=this,e={type:"change"};this.object=a;this.object.rotation.reorder("YXZ");this.enabled=!0;this.deviceOrientation=
null;this.alphaOffset=this.screenOrientation=0;this.initialOffset=null;var f=function(a){var f=a.alpha,c=a.beta;a=a.gamma;null===b.initialOffset&&(b.initialOffset=f);f-=b.initialOffset;0>f&&(f+=360);b.deviceOrientation={alpha:f,beta:c,gamma:a};b.update();b.dispatchEvent(e)},m=function(){b.screenOrientation=window.orientation||0;b.update();b.dispatchEvent(e)},d=function(){window.addEventListener("orientationchange",m,!1);window.addEventListener("deviceorientation",f,!1)}.bind(this),q=function(){var a=
new c.Vector3(0,0,1),b=new c.Euler,f=new c.Quaternion,e=new c.Quaternion(-Math.sqrt(.5),0,0,Math.sqrt(.5));return function(c,m,d,F,q){b.set(d,m,-F,"YXZ");c.setFromEuler(b);c.multiply(e);c.multiply(f.setFromAxisAngle(a,-q))}}();this.connect=function(){m();void 0!==window.DeviceOrientationEvent&&"function"===typeof window.DeviceOrientationEvent.requestPermission?window.DeviceOrientationEvent.requestPermission().then(function(a){"granted"==a&&d()}).catch(function(a){console.error("THREE.DeviceOrientationControls: Unable to use DeviceOrientation API:",
a)}):d();b.enabled=!0};this.disconnect=function(){window.removeEventListener("orientationchange",m,!1);window.removeEventListener("deviceorientation",f,!1);b.enabled=!1;b.deviceOrientation=null;b.initialOffset=null};this.update=function(a){a=void 0===a?{theta:0}:a;a=void 0===a.theta?0:a.theta;if(!1!==b.enabled){var f=b.deviceOrientation;if(f){var e=f.alpha?c.Math.degToRad(f.alpha)+b.alphaOffset:0,m=f.beta?c.Math.degToRad(f.beta):0;f=f.gamma?c.Math.degToRad(f.gamma):0;var d=b.screenOrientation?c.Math.degToRad(b.screenOrientation):
0;q(b.object.quaternion,e+a,m,f,d)}}};this.dispose=function(){b.disconnect()};this.getAlpha=function(){var a=b.deviceOrientation;return a&&a.alpha?c.Math.degToRad(a.alpha)+b.alphaOffset:0};this.getBeta=function(){var a=b.deviceOrientation;return a&&a.beta?c.Math.degToRad(a.beta):0}}function ya(a){var b=new c.OrthographicCamera(-1,1,1,-1,0,1),e=new c.Scene,f=new c.StereoCamera;f.aspect=.5;var m=new c.WebGLRenderTarget(512,512,{minFilter:c.LinearFilter,magFilter:c.NearestFilter,format:c.RGBAFormat});
m.scissorTest=!0;m.texture.generateMipmaps=!1;var d=new c.Vector2(.441,.156),q=(new c.PlaneBufferGeometry(1,1,10,20)).deleteAttribute("normal").toNonIndexed(),g=q.attributes.position.array,w=q.attributes.uv.array;q.attributes.position.count*=2;q.attributes.uv.count*=2;var l=new Float32Array(2*g.length);l.set(g);l.set(g,g.length);var k=new Float32Array(2*w.length);k.set(w);k.set(w,w.length);w=new c.Vector2;g=g.length/3;for(var h=0,L=l.length/3;h<L;h++){w.x=l[3*h];w.y=l[3*h+1];var n=w.dot(w);n=1.5+
(d.x+d.y*n)*n;var p=h<g?0:1;l[3*h]=w.x/n*1.5-.5+p;l[3*h+1]=w.y/n*3;k[2*h]=.5*(k[2*h]+p)}q.attributes.position.array=l;q.attributes.uv.array=k;d=new c.MeshBasicMaterial({map:m.texture});q=new c.Mesh(q,d);e.add(q);this.setEyeSeparation=function(a){f.eyeSep=a};this.setSize=function(b,f){a.setSize(b,f);var e=a.getPixelRatio();m.setSize(b*e,f*e)};this.render=function(c,d,F){var h=F instanceof P||F instanceof Q;c.updateMatrixWorld();h&&this.setEyeSeparation(F.stereo.eyeSep);null===d.parent&&d.updateMatrixWorld();
f.update(d);d=m.width/2;var q=m.height;a.autoClear&&a.clear();h&&F.updateTextureToLeft();m.scissor.set(0,0,d,q);m.viewport.set(0,0,d,q);a.setRenderTarget(m);a.render(c,f.cameraL);a.clearDepth();h&&F.updateTextureToRight();m.scissor.set(d,0,d,q);m.viewport.set(d,0,d,q);a.setRenderTarget(m);a.render(c,f.cameraR);a.clearDepth();a.setRenderTarget(null);a.render(e,b)}}function pa(a){a=void 0===a?{}:a;var b=this.options=Object.assign({container:this.setupContainer(a.container),controlBar:!0,controlButtons:["fullscreen",
"setting","video"],autoHideControlBar:!1,autoHideInfospot:!0,horizontalView:!1,clickTolerance:10,cameraFov:60,reverseDragging:!1,enableReticle:!1,dwellTime:1500,autoReticleSelect:!0,viewIndicator:!1,indicatorSize:30,output:null,autoRotate:!1,autoRotateSpeed:2,autoRotateActivationDuration:5E3,initialLookAt:new c.Vector3(0,0,-Number.MAX_SAFE_INTEGER),momentum:!0,rotateSpeed:-1,dampingFactor:.9,speedLimit:Number.MAX_VALUE},a);a=b.container;var e=b.cameraFov,f=b.controlBar,m=b.controlButtons,d=b.viewIndicator,
q=b.indicatorSize,g=b.enableReticle,w=b.reverseDragging,l=b.output,k=b.scene,h=b.camera;b=b.renderer;var n=a.clientWidth,p=a.clientHeight;this.container=a;this.scene=this.setupScene(k);this.sceneReticle=new c.Scene;this.camera=this.setupCamera(e,n/p,h);this.renderer=this.setupRenderer(b,a);this.reticle=this.addReticle(this.camera,this.sceneReticle);this.control=this.setupControls(this.camera,a);this.effect=this.setupEffects(this.renderer,a);this.mode=y.NORMAL;this.pressObject=this.pressEntityObject=
this.infospot=this.hoverObject=this.widget=this.panorama=null;this.raycaster=new c.Raycaster;this.raycasterPoint=new c.Vector2;this.userMouse=new c.Vector2;this.updateCallbacks=[];this.requestAnimationId=null;this.cameraFrustum=new c.Frustum;this.cameraViewProjectionMatrix=new c.Matrix4;this.outputDivElement=this.autoRotateRequestId=null;this.touchSupported="ontouchstart"in window||window.DocumentTouch&&document instanceof DocumentTouch;this.tweenLeftAnimation=new t.Tween;this.tweenUpAnimation=new t.Tween;
this.tweenCanvasOpacityOut=new t.Tween;this.tweenCanvasOpacityIn=new t.Tween;this.outputEnabled=!1;this.viewIndicatorSize=q;this.tempEnableReticle=g;this.setupTween();this.handlerMouseUp=this.onMouseUp.bind(this);this.handlerMouseDown=this.onMouseDown.bind(this);this.handlerMouseMove=this.onMouseMove.bind(this);this.handlerWindowResize=this.onWindowResize.bind(this);this.handlerKeyDown=this.onKeyDown.bind(this);this.handlerKeyUp=this.onKeyUp.bind(this);this.handlerTap=this.onTap.bind(this,{clientX:n/
2,clientY:p/2});f&&this.addDefaultControlBar(m);d&&this.addViewIndicator();w&&this.reverseDraggingDirection();g?this.enableReticleControl():this.registerMouseAndTouchEvents();"overlay"===l&&this.addOutputElement();this.registerEventListeners();this.animate.call(this)}var za="^0.117.0".replace(/[^0-9.]/g,""),M={ORBIT:0,DEVICEORIENTATION:1},y={UNKNOWN:0,NORMAL:1,CARDBOARD:2,STEREO:3},O={TAB:0,SBS:1},g={CONTAINER:"panolens-container",CAMERA:"panolens-camera",CONTROLS:"panolens-controls",LOAD_START:"load-start",
LOAD:"load",LOADED:"loaded",READY:"ready",ERROR:"error",ENTER:"enter",ENTER_START:"enter-start",ENTER_FADE_START:"enter-fade-start",ENTER_FADE_COMPLETE:"enter-fade-complete",ENTER_COMPLETE:"enter-complete",FADE_IN:"fade-in",FADE_OUT:"fade-out",PROGRESS:"progress",LEAVE:"leave",LEAVE_START:"leave-start",LEAVE_COMPLETE:"leave-complete",INFOSPOT_ANIMATION_COMPLETE:"infospot-animation-complete",VIEWER_HANDLER:"panolens-viewer-handler",MODE_CHANGE:"mode-change",WIDNOW_RESIZE:"window-resize",MEDIA:{PLAY:"play",
PAUSE:"pause",VOLUME_CHANGE:"volumechange"},RETICLE:{RETICLE_RIPPLE_START:"reticle-ripple-start",RETICLE_RIPPLE_END:"reticle-ripple-end",RETICLE_START:"reticle-start",RETICLE_END:"reticle-end",RETICLE_UPDATE:"reticle-update"},PANOMOMENT:{NONE:"panomoments.none",FIRST_FRAME_DECODED:"panomoments.first_frame_decoded",READY:"panomoments.ready",COMPLETED:"panomoments.completed"}},A={Info:"data:image/png;base64,",
...
qa={load:function(a,b,e,f){b=void 0===b?function(){}:b;e=void 0===e?function(){}:e;f=void 0===f?function(){}:f;c.Cache.enabled=!0;var m,d,q,g;for(g in A)A.hasOwnProperty(g)&&a===A[g]&&(m=g);var w=c.Cache.get(m?m:a);if(void 0!==w)return b&&requestAnimationFrame(function(){e({loaded:1,total:1});b(w)}),w;var l=window.URL||window.webkitURL;var k=document.createElementNS("http://www.w3.org/1999/xhtml","img");c.Cache.add(m?m:a,k);var h=function(){l.revokeObjectURL(k.src);b(k)};if(0===a.indexOf("data:"))return k.addEventListener("load",
h,!1),k.src=a,k;k.crossOrigin=void 0!==this.crossOrigin?this.crossOrigin:"";m=new window.XMLHttpRequest;m.open("GET",a,!0);m.responseType="arraybuffer";m.addEventListener("error",f);m.addEventListener("progress",function(a){if(a){var b=a.loaded,f=a.total;a.lengthComputable&&e({loaded:b,total:f})}});m.addEventListener("loadend",function(a){a&&(d=new Uint8Array(a.currentTarget.response),q=new window.Blob([d]),k.addEventListener("load",h,!1),k.src=l.createObjectURL(q))});m.send(null)}},Z={load:function(a,
b,e,f){b=void 0===b?function(){}:b;var m=new c.Texture;qa.load(a,function(f){m.image=f;f=0<a.search(/\.(jpg|jpeg)$/)||0===a.search(/^data:image\/jpeg/);m.format=f?c.RGBFormat:c.RGBAFormat;m.needsUpdate=!0;b(m)},e,f);return m}},ta={load:function(a,b,e,f){b=void 0===b?function(){}:b;e=void 0===e?function(){}:e;var m;var d=new c.CubeTexture([]);var q=0;var g={};var w={};a.map(function(a,c){qa.load(a,function(a){d.images[c]=a;q++;6===q&&(d.needsUpdate=!0,e({loaded:q,total:6}),b(d))},function(a){g[c]=
{loaded:a.loaded,total:a.total};w.loaded=0;m=w.total=0;for(var b in g)m++,w.loaded+=g[b].loaded,w.total+=g[b].total;6>m&&(w.total=w.total/m*6);e(w)},f)});return d}};n.prototype=Object.assign(Object.create(c.EventDispatcher.prototype),{setContainer:function(a){this.container=a},setScene:function(a){this.scene=a},enumerateDevices:function(){var a=this.devices,b=new Promise(function(b){b(a)});return 0<a.length?b:window.navigator.mediaDevices.enumerateDevices()},switchNextVideoDevice:function(){var a=
...
1):e.repeat.set(1,1/f)}}});Object.assign(v.prototype,{constructor:v,updateUniformByFormat:function(a,b){this.format=a;var e=b.repeat.value;b=b.offset.value;var f=this.loffset,c=this.roffset;switch(a){case O.TAB:e.set(1,.5);b.set(0,.5);f.set(0,.5);c.set(0,0);break;case O.SBS:e.set(.5,1),b.set(0,0),f.set(0,0),c.set(.5,0)}},updateTextureToLeft:function(a){a.copy(this.loffset)},updateTextureToRight:function(a){a.copy(this.roffset)}});p.prototype=Object.assign(Object.create(c.Sprite.prototype),{constructor:p,
...
e=this.canvasWidth,f=this.canvasHeight,c=this.material,d=this.dpr,q=a*Math.PI*2,g=this.color.getStyle(),w=.5*e/d;d=.5*f/d;b.clearRect(0,0,e,f);b.beginPath();0===a?(b.arc(w,d,e/16,0,2*Math.PI),b.fillStyle=g,b.fill()):(b.arc(w,d,e/4-3,-Math.PI/2,-Math.PI/2+q),b.strokeStyle=g,b.lineWidth=3,b.stroke());b.closePath();c.map.needsUpdate=!0},ripple:function(){var a=this,b=this.context,e=this.canvasWidth,f=this.canvasHeight,c=this.material,d=this.rippleDuration,q=performance.now(),G=this.color,w=this.dpr,
l=.5*e/w,k=.5*f/w,h=function(){var m=window.requestAnimationFrame(h),F=(performance.now()-q)/d,n=0<1-F?1-F:0,p=F*e*.5/w;b.clearRect(0,0,e,f);b.beginPath();b.arc(l,k,p,0,2*Math.PI);b.fillStyle="rgba("+255*G.r+", "+255*G.g+", "+255*G.b+", "+n+")";b.fill();b.closePath();1<=F&&(window.cancelAnimationFrame(m),a.updateCanvasArcByProgress(0),a.dispatchEvent({type:g.RETICLE.RETICLE_RIPPLE_END}));c.map.needsUpdate=!0};this.dispatchEvent({type:g.RETICLE.RETICLE_RIPPLE_START});h()},show:function(){this.visible=
...
this,b=this.createCustomItem({style:{float:"left",backgroundImage:'url("'+A.VideoPlay+'")'},onTap:function(e){e.preventDefault();e.stopPropagation();a.dispatchEvent({type:g.VIEWER_HANDLER,method:"toggleVideoPlay",data:!this.paused});this.paused=!this.paused;b.update()}});b.paused=!0;b.update=function(a){this.paused=void 0!==a?a:this.paused;this.style.backgroundImage='url("'+(this.paused?A.VideoPlay:A.VideoPause)+'")'};return b},createVideoControlSeekbar:function(){function a(a){a.stopPropagation();
d=!0;q=a.clientX||a.changedTouches&&a.changedTouches[0].clientX;l=parseInt(n.style.width)/100;c.container.addEventListener("mousemove",b,{passive:!0});c.container.addEventListener("mouseup",e,{passive:!0});c.container.addEventListener("touchmove",b,{passive:!0});c.container.addEventListener("touchend",e,{passive:!0})}function b(a){d&&(k=((a.clientX||a.changedTouches&&a.changedTouches[0].clientX)-q)/h.clientWidth,k=l+k,k=1<k?1:0>k?0:k,h.setProgress(k),c.dispatchEvent({type:g.VIEWER_HANDLER,method:"setVideoCurrentTime",
data:k}))}function e(a){a.stopPropagation();d=!1;f()}function f(){c.container.removeEventListener("mousemove",b,!1);c.container.removeEventListener("mouseup",e,!1);c.container.removeEventListener("touchmove",b,!1);c.container.removeEventListener("touchend",e,!1)}var c=this,d=!1,q,l,k;var n=document.createElement("div");n.style.width="0%";n.style.height="100%";n.style.backgroundColor="#fff";var p=document.createElement("div");p.style.float="right";p.style.width="14px";p.style.height="14px";p.style.transform=
"translate(7px, -5px)";p.style.borderRadius="50%";p.style.backgroundColor="#ddd";p.addEventListener("mousedown",a,{passive:!0});p.addEventListener("touchstart",a,{passive:!0});n.appendChild(p);var h=this.createCustomItem({style:{float:"left",width:"30%",height:"4px",marginTop:"20px",backgroundColor:"rgba(188,188,188,0.8)"},onTap:function(a){a.preventDefault();a.stopPropagation();if(a.target!==p){var b=a.changedTouches&&0<a.changedTouches.length?(a.changedTouches[0].pageX-a.target.getBoundingClientRect().left)/
this.clientWidth:a.offsetX/this.clientWidth;c.dispatchEvent({type:g.VIEWER_HANDLER,method:"setVideoCurrentTime",data:b});h.setProgress(a.offsetX/this.clientWidth)}},onDispose:function(){f();p=n=null}});h.appendChild(n);h.setProgress=function(a){n.style.width=100*a+"%"};this.addEventListener("video-update",function(a){h.setProgress(a.percentage)});h.progressElement=n;h.progressElementControl=p;return h},createMenuItem:function(a){var b=this,e=document.createElement("a");e.textContent=a;e.style.display=
...
b.style.fontSize="13px";b.style.fontWeight="300";b.style.float="right";this.selection=b;this.setSelectionTitle(a);this.appendChild(b);return this};e.addIcon=function(a,b,e){a=void 0===a?A.ChevronRight:a;b=void 0===b?!1:b;e=void 0===e?!1:e;var c=document.createElement("span");c.style.float=b?"left":"right";c.style.width="17px";c.style.height="17px";c.style["margin"+(b?"Right":"Left")]="12px";c.style.backgroundSize="cover";e&&(c.style.transform="rotateZ(180deg)");this.icon=c;this.setIcon(a);this.appendChild(c);
...
a[d].subMenu)}return c},createSubMenu:function(a,b){function e(a){a.preventDefault();a.stopPropagation();d=c.mainMenu;d.changeSize(d._width);d.unslideAll();d.show();g.slideAll(!0);g.hide();"header"!==this.type&&(g.setActiveItem(this),c.activeMainItem.setSelectionTitle(this.textContent),this.handler&&this.handler())}var c=this,d,g=this.createMenu();g.items=b;g.activeItem=null;g.addHeader(a).addIcon(void 0,!0,!0).addEventListener(c.TOUCH_ENABLED?"touchend":"click",e,!1);for(a=0;a<b.length;a++){var q=
g.addItem(b[a].title);q.style.fontWeight=300;q.handler=b[a].handler;q.addIcon(" ",!0);q.addEventListener(c.TOUCH_ENABLED?"touchend":"click",e,!1);g.activeItem||g.setActiveItem(q)}g.slideAll(!0);return g},createMenu:function(){var a=this,b=document.createElement("span"),e=b.style;e.padding="5px 0";e.position="fixed";e.bottom="100%";e.right="14px";e.backgroundColor="#fafafa";e.fontFamily="Helvetica Neue";e.fontSize="14px";e.visibility="hidden";e.opacity=0;e.boxShadow="0 0 12pt rgba(0,0,0,0.25)";e.borderRadius=
...
"click",a.onTap,!1);if(c)a.onDispose()};return e},mergeStyleOptions:function(a,b){b=void 0===b?{}:b;for(var e in b)b.hasOwnProperty(e)&&(a.style[e]=b[e]);return a},dispose:function(){this.barElement&&(this.container.removeChild(this.barElement),this.barElement.dispose(),this.barElement=null)}});var Aa={texture:{value:new c.Texture},repeat:{value:new c.Vector2(1,1)},offset:{value:new c.Vector2(0,0)},opacity:{value:1}};l.prototype=Object.assign(Object.create(c.Mesh.prototype),{constructor:l,createGeometry:function(a){return new c.BoxBufferGeometry(a,
...
vertexShader:"\n         varying vec3 vWorldDirection;\n         #include <common>\n         void main() {\n             vWorldDirection = transformDirection( position, modelMatrix );\n             #include <begin_vertex>\n             #include <project_vertex>\n         }\n     ",uniforms:e,side:c.BackSide,transparent:!0})},add:function(a){if(1<arguments.length){for(var b=0;b<arguments.length;b++)this.add(arguments[b]);return this}a instanceof u&&((b=this.container)&&a.dispatchEvent({type:g.CONTAINER,
container:b}),a.dispatchEvent({type:"panolens-infospot-focus",method:function(a,b,c){this.dispatchEvent({type:g.VIEWER_HANDLER,method:"tweenControlCenter",data:[a,b,c]})}.bind(this)}));c.Object3D.prototype.add.call(this,a)},getTexture:function(){return this.material.uniforms.texture.value},load:function(a){a=void 0===a?!0:a;this.dispatchEvent({type:g.LOAD_START});if(a)this.onLoad()},onClick:function(a){a.intersects&&0===a.intersects.length&&this.traverse(function(a){a.dispatchEvent({type:"dismiss"})})},
setContainer:function(a){if(a instanceof HTMLElement)var b=a;else a&&a.container&&(b=a.container);b&&(this.children.forEach(function(a){a instanceof u&&a.dispatchEvent&&a.dispatchEvent({type:g.CONTAINER,container:b})}),this.container=b)},onLoad:function(){this.loaded=!0;this.dispatchEvent({type:g.LOADED});this.dispatchEvent({type:g.LOAD});this.dispatchEvent({type:g.READY})},onProgress:function(a){this.dispatchEvent({type:g.PROGRESS,progress:a})},onError:function(){this.dispatchEvent({type:g.READY})},
getZoomLevel:function(){return 800>=window.innerWidth?this.ImageQualityFair:800<window.innerWidth&&1280>=window.innerWidth?this.ImageQualityMedium:1280<window.innerWidth&&1920>=window.innerWidth?this.ImageQualityHigh:1920<window.innerWidth?this.ImageQualitySuperHigh:this.ImageQualityLow},updateTexture:function(a){this.material.uniforms.texture.value=a},toggleInfospotVisibility:function(a,b){b=void 0!==b?b:0;var e=void 0!==a?a:this.isInfospotVisible?!1:!0;this.traverse(function(a){a instanceof u&&
(e?a.show(b):a.hide(b))});this.isInfospotVisible=e;this.infospotAnimation.onComplete(function(){this.dispatchEvent({type:g.INFOSPOT_ANIMATION_COMPLETE,visible:e})}.bind(this)).delay(b).start()},setLinkingImage:function(a,b){this.linkingImageURL=a;this.linkingImageScale=b},link:function(a,b,e,c){this.visible=!0;b?(e=void 0!==e?e:void 0!==a.linkingImageScale?a.linkingImageScale:300,c=c?c:a.linkingImageURL?a.linkingImageURL:A.Arrow,c=new u(e,c),c.position.copy(b),c.toPanorama=a,c.addEventListener("click",
function(){this.dispatchEvent({type:g.VIEWER_HANDLER,method:"setPanorama",data:a})}.bind(this)),this.linkedSpots.push(c),this.add(c),this.visible=!1):console.warn("Please specify infospot position for linking")},reset:function(){this.children.length=0},setupTransitions:function(){this.fadeInAnimation=new t.Tween;this.fadeOutAnimation=new t.Tween;this.enterTransition=(new t.Tween(this)).easing(t.Easing.Quartic.Out).onComplete(function(){this.dispatchEvent({type:g.ENTER_COMPLETE})}.bind(this)).start();
this.leaveTransition=(new t.Tween(this)).easing(t.Easing.Quartic.Out)},fadeIn:function(a){a=void 0===a?this.animationDuration:a;this.dispatchEvent({type:g.FADE_IN});var b=(this.material.uniforms?this.material.uniforms:{opacity:this.material.opacity}).opacity,e=function(){this.visible=!0;this.dispatchEvent({type:g.ENTER_FADE_START})}.bind(this),c=function(){this.toggleInfospotVisibility(!0,a/2);this.dispatchEvent({type:g.ENTER_FADE_COMPLETE})}.bind(this);this.fadeOutAnimation.stop();this.fadeInAnimation=
(new t.Tween(b)).to({value:1},a).easing(t.Easing.Quartic.Out).onStart(e).onComplete(c).start()},fadeOut:function(a){a=void 0===a?this.animationDuration:a;this.dispatchEvent({type:g.FADE_OUT});var b=(this.material.uniforms?this.material.uniforms:{opacity:this.material.opacity}).opacity,e=function(){this.visible=!1;this.dispatchEvent({type:g.LEAVE_COMPLETE})}.bind(this);this.fadeInAnimation.stop();this.fadeOutAnimation=(new t.Tween(b)).to({value:0},a).easing(t.Easing.Quartic.Out).onComplete(e).start()},
onEnter:function(){var a=this.animationDuration;this.dispatchEvent({type:g.ENTER});this.leaveTransition.stop();this.enterTransition.to({},a).onStart(function(){this.dispatchEvent({type:g.ENTER_START});this.loaded?this.dispatchEvent({type:g.READY}):this.load()}.bind(this)).start();this.children.forEach(function(a){a.dispatchEvent({type:"panorama-enter"})});this.active=!0},onLeave:function(){var a=this.animationDuration;this.enterTransition.stop();this.leaveTransition.to({},a).onStart(function(){this.dispatchEvent({type:g.LEAVE_START});
this.fadeOut(a);this.toggleInfospotVisibility(!1)}.bind(this)).start();this.dispatchEvent({type:g.LEAVE});this.traverse(function(a){return a.dispatchEvent({type:"panorama-leave"})});this.active=!1},dispose:function(){function a(b){for(var e=b.geometry,c=b.material,d=b.children.length-1;0<=d;d--)a(b.children[d]),b.remove(b.children[d]);b instanceof u&&b.dispose();e&&(e.dispose(),b.geometry=null);c&&(c.dispose(),b.material=null)}var b=this.material;b&&b.uniforms&&b.uniforms.texture&&b.uniforms.texture.value.dispose();
this.infospotAnimation.stop();this.fadeInAnimation.stop();this.fadeOutAnimation.stop();this.enterTransition.stop();this.leaveTransition.stop();this.dispatchEvent({type:g.VIEWER_HANDLER,method:"onPanoramaDispose",data:this});a(this);this.parent&&this.parent.remove(this)}});k.prototype=Object.assign(Object.create(l.prototype),{constructor:k,load:function(a){l.prototype.load.call(this,!1);a=a||this.src;if(!a)console.warn("Image source undefined");else if("string"===typeof a)Z.load(a,this.onLoad.bind(this),
this.onProgress.bind(this),this.onError.bind(this));else if(a instanceof HTMLImageElement)this.onLoad(new c.Texture(a))},onLoad:function(a){a.minFilter=a.magFilter=c.LinearFilter;a.generateMipmaps=!1;a.format=c.RGBFormat;a.needsUpdate=!0;this.updateTexture(a);window.requestAnimationFrame(l.prototype.onLoad.bind(this))},reset:function(){l.prototype.reset.call(this)},dispose:function(){c.Cache.remove(this.src);l.prototype.dispose.call(this)}});K.prototype=Object.assign(Object.create(l.prototype),{constructor:K,
createGeometry:function(){var a=new c.BufferGeometry;a.setAttribute("position",new c.BufferAttribute(new Float32Array,1));return a},createMaterial:function(){return new c.MeshBasicMaterial({color:0,opacity:0,transparent:!0})},getTexture:function(){return null}});U.prototype=Object.assign(Object.create(l.prototype),{constructor:U,createMaterial:function(){var a=c.ShaderLib.cube,b=a.fragmentShader,e=a.vertexShader;a=c.UniformsUtils.clone(a.uniforms);a.opacity.value=0;a.envMap.value=new c.CubeTexture;
b=new c.ShaderMaterial({fragmentShader:b,vertexShader:e,uniforms:a,side:c.BackSide,opacity:0,transparent:!0});Object.defineProperty(b,"envMap",{get:function(){return this.uniforms.envMap.value}});return b},load:function(){l.prototype.load.call(this,!1);ta.load(this.images,this.onLoad.bind(this),this.onProgress.bind(this),this.onError.bind(this))},onLoad:function(a){this.material.uniforms.envMap.value=a;l.prototype.onLoad.call(this)},getTexture:function(){return this.material.uniforms.envMap.value},
dispose:function(){var a=this.material.uniforms.envMap.value;this.images.forEach(function(a){c.Cache.remove(a)});a instanceof c.CubeTexture&&a.dispose();l.prototype.dispose.call(this)}});ea.prototype=Object.assign(Object.create(U.prototype),{constructor:ea});var ra=window.navigator.userAgent||window.navigator.vendor||window.opera,ua=/(android|bb\d+|meego).+mobile|avantgo|bada\/|blackberry|blazer|compal|elaine|fennec|hiptop|iemobile|ip(hone|od)|iris|kindle|lge |maemo|midp|mmp|mobile.+firefox|netfront|opera m(ob|in)i|palm( os)?|phone|p(ixi|re)\/|plucker|pocket|psp|series(4|6)0|symbian|treo|up\.(browser|link)|vodafone|wap|windows (ce|phone)|xda|xiino/i.test(ra)||
/1207|6310|6590|3gso|4thp|50[1-6]i|770s|802s|a wa|abac|ac(er|oo|s\-)|ai(ko|rn)|al(av|ca|co)|amoi|an(ex|ny|yw)|aptu|ar(ch|go)|as(te|us)|attw|au(di|\-m|r |s )|avan|be(ck|ll|nq)|bi(lb|rd)|bl(ac|az)|br(e|v)w|bumb|bw\-(n|u)|c55\/|capi|ccwa|cdm\-|cell|chtm|cldc|cmd\-|co(mp|nd)|craw|da(it|ll|ng)|dbte|dc\-s|devi|dica|dmob|do(c|p)o|ds(12|\-d)|el(49|ai)|em(l2|ul)|er(ic|k0)|esl8|ez([4-7]0|os|wa|ze)|fetc|fly(\-|_)|g1 u|g560|gene|gf\-5|g\-mo|go(\.w|od)|gr(ad|un)|haie|hcit|hd\-(m|p|t)|hei\-|hi(pt|ta)|hp( i|ip)|hs\-c|ht(c(\-| |_|a|g|p|s|t)|tp)|hu(aw|tc)|i\-(20|go|ma)|i230|iac( |\-|\/)|ibro|idea|ig01|ikom|im1k|inno|ipaq|iris|ja(t|v)a|jbro|jemu|jigs|kddi|keji|kgt( |\/)|klon|kpt |kwc\-|kyo(c|k)|le(no|xi)|lg( g|\/(k|l|u)|50|54|\-[a-w])|libw|lynx|m1\-w|m3ga|m50\/|ma(te|ui|xo)|mc(01|21|ca)|m\-cr|me(rc|ri)|mi(o8|oa|ts)|mmef|mo(01|02|bi|de|do|t(\-| |o|v)|zz)|mt(50|p1|v )|mwbp|mywa|n10[0-2]|n20[2-3]|n30(0|2)|n50(0|2|5)|n7(0(0|1)|10)|ne((c|m)\-|on|tf|wf|wg|wt)|nok(6|i)|nzph|o2im|op(ti|wv)|oran|owg1|p800|pan(a|d|t)|pdxg|pg(13|\-([1-8]|c))|phil|pire|pl(ay|uc)|pn\-2|po(ck|rt|se)|prox|psio|pt\-g|qa\-a|qc(07|12|21|32|60|\-[2-7]|i\-)|qtek|r380|r600|raks|rim9|ro(ve|zo)|s55\/|sa(ge|ma|mm|ms|ny|va)|sc(01|h\-|oo|p\-)|sdk\/|se(c(\-|0|1)|47|mc|nd|ri)|sgh\-|shar|sie(\-|m)|sk\-0|sl(45|id)|sm(al|ar|b3|it|t5)|so(ft|ny)|sp(01|h\-|v\-|v )|sy(01|mb)|t2(18|50)|t6(00|10|18)|ta(gt|lk)|tcl\-|tdg\-|tel(i|m)|tim\-|t\-mo|to(pl|sh)|ts(70|m\-|m3|m5)|tx\-9|up(\.b|g1|si)|utst|v400|v750|veri|vi(rg|te)|vk(40|5[0-3]|\-v)|vm40|voda|vulc|vx(52|53|60|61|70|80|81|83|85|98)|w3c(\-| )|webc|whit|wi(g |nc|nw)|wmlb|wonu|x700|yas\-|your|zeto|zte\-/i.test(ra.substr(0,
4)),va=/(android)/i.test(ra);B.prototype=Object.assign(Object.create(l.prototype),{constructor:B,load:function(){l.prototype.load.call(this,!1);var a=this.options,b=a.muted,e=a.loop,c=a.autoplay,d=a.playsinline;a=a.crossOrigin;var k=this.videoElement,q=this.onProgress.bind(this),n=this.onLoad.bind(this);k.loop=e;k.autoplay=c;k.playsinline=d;k.crossOrigin=a;k.muted=b;d&&(k.setAttribute("playsinline",""),k.setAttribute("webkit-playsinline",""));d=function(){var a=this.setVideoTexture(k);c&&this.dispatchEvent({type:g.VIEWER_HANDLER,
method:"updateVideoPlayButton",data:!1});ua&&(k.pause(),c&&b?this.dispatchEvent({type:g.VIEWER_HANDLER,method:"updateVideoPlayButton",data:!1}):this.dispatchEvent({type:g.VIEWER_HANDLER,method:"updateVideoPlayButton",data:!0}));window.requestAnimationFrame(function(){q({loaded:1,total:1});n(a)})};2<k.readyState?d.call(this):(0===k.querySelectorAll("source").length&&(a=document.createElement("source"),a.src=this.src,k.appendChild(a)),k.load());k.addEventListener("loadeddata",d.bind(this));k.addEventListener("timeupdate",
function(){this.videoProgress=0<=k.duration?k.currentTime/k.duration:0;this.dispatchEvent({type:g.VIEWER_HANDLER,method:"onVideoUpdate",data:this.videoProgress})}.bind(this));k.addEventListener("ended",function(){e||(this.resetVideo(),this.dispatchEvent({type:g.VIEWER_HANDLER,method:"updateVideoPlayButton",data:!0}))}.bind(this),!1)},onLoad:function(){l.prototype.onLoad.call(this)},setVideoTexture:function(a){if(a)return a=new c.VideoTexture(a),a.minFilter=c.LinearFilter,a.magFilter=c.LinearFilter,
...
(a.muted=!1);this.dispatchEvent({type:g.MEDIA.VOLUME_CHANGE})},getVideoElement:function(){return this.videoElement},dispose:function(){this.pauseVideo();this.removeEventListener(g.LEAVE,this.pauseVideo.bind(this));this.removeEventListener(g.ENTER_FADE_START,this.resumeVideoProgress.bind(this));this.removeEventListener("video-toggle",this.toggleVideo.bind(this));this.removeEventListener("video-time",this.setVideoCurrentTime.bind(this));l.prototype.dispose.call(this)}});Object.assign(T.prototype,{constructor:T,
...
e=this;this._count=0;this._total=a*b;for(var c=this._parameters.useWebGL,d=0;d<b;d++)for(var g={},k=0;k<a;g={$jscomp$loop$prop$url$2:g.$jscomp$loop$prop$url$2},k++)g.$jscomp$loop$prop$url$2="https://geo0.ggpht.com/cbk?cb_client=maps_sv.tactile&authuser=0&hl=en&output=tile&zoom="+this._zoom+"&x="+k+"&y="+d+"&panoid="+this._panoId+"&nbt&fover=2",function(a){return function(b,d){if(c)var f=Z.load(a.$jscomp$loop$prop$url$2,null,function(){e.composeFromTile(b,d,f)});else{var g=new Image;g.addEventListener("load",
function(){e.composeFromTile(b,d,this)});g.crossOrigin="";g.src=a.$jscomp$loop$prop$url$2}}}(g)(k,d)},load:function(a){this.loadPano(a)},loadPano:function(a){var b=this;this._panoClient.getPanoramaById(a,function(a,c){c===google.maps.StreetViewStatus.OK&&(b.result=a,b.copyright=a.copyright,b._panoId=a.location.pano,b.composePanorama())})},setZoom:function(a){this._zoom=a;this.adaptTextureToZoom()}});da.prototype=Object.assign(Object.create(k.prototype),{constructor:da,load:function(a){l.prototype.load.call(this,
...
setGSVLoader:function(){this.gsvLoader=new T;this.loadRequested&&this.load()},getGSVLoader:function(){return this.gsvLoader},loadGSVLoader:function(a){this.loadRequested=!1;this.gsvLoader.onProgress=this.onProgress.bind(this);this.gsvLoader.onPanoramaLoad=this.onLoad.bind(this);this.gsvLoader.setZoom(this.getZoomLevel());this.gsvLoader.load(a);this.gsvLoader.loaded=!0},onLoad:function(a){k.prototype.onLoad.call(this,new c.Texture(a))},reset:function(){this.gsvLoader=void 0;k.prototype.reset.call(this)}});
var Ba={tDiffuse:{value:new c.Texture},resolution:{value:1},transform:{value:new c.Matrix4},zoom:{value:1},opacity:{value:1}};H.prototype=Object.assign(Object.create(k.prototype),{constructor:H,add:function(a){if(1<arguments.length){for(var b=0;b<arguments.length;b++)this.add(arguments[b]);return this}a instanceof u&&(a.material.depthTest=!1);k.prototype.add.call(this,a)},createGeometry:function(a){return new c.PlaneBufferGeometry(a,.5*a)},createMaterial:function(a){a=void 0===a?this.edgeLength:a;
...
this.container.clientHeight;this.registerMouseEvents();this.onUpdateCallback();this.dispatchEvent({type:g.VIEWER_HANDLER,method:"disableControl"});k.prototype.onLoad.call(this,a)},onLeave:function(){this.unregisterMouseEvents();this.dispatchEvent({type:g.VIEWER_HANDLER,method:"enableControl",data:M.ORBIT});window.cancelAnimationFrame(this.frameId);k.prototype.onLeave.call(this)},onWindowResize:function(){this.material.uniforms.resolution.value=this.container.clientWidth/this.container.clientHeight},
onContextMenu:function(){this.dragging=!1},dispose:function(){this.unregisterMouseEvents();k.prototype.dispose.call(this)}});aa.prototype=Object.assign(Object.create(H.prototype),{constructor:aa,onLoad:function(a){this.updateTexture(a);H.prototype.onLoad.call(this,a)},updateTexture:function(a){a.minFilter=a.magFilter=c.LinearFilter;this.material.uniforms.tDiffuse.value=a},dispose:function(){var a=this.material.uniforms.tDiffuse;a&&a.value&&a.value.dispose();H.prototype.dispose.call(this)}});X.prototype=
Object.assign(Object.create(l.prototype),{constructor:X,onPanolensContainer:function(a){this.media.setContainer(a.container)},onPanolensScene:function(a){this.media.setScene(a.scene)},start:function(){return this.media.start()},stop:function(){this.media.stop()}});P.prototype=Object.assign(Object.create(k.prototype),{constructor:P,onLoad:function(a){var b=a.image;this.stereo.updateUniformByFormat(4===b.width/b.height?O.SBS:O.TAB,this.material.uniforms);this.material.uniforms.texture.value=a;k.prototype.onLoad.call(this,
a)},updateTextureToLeft:function(){this.stereo.updateTextureToLeft(this.material.uniforms.offset.value)},updateTextureToRight:function(){this.stereo.updateTextureToRight(this.material.uniforms.offset.value)},dispose:function(){var a=this.material.uniforms.texture.value;a instanceof c.Texture&&a.dispose();k.prototype.dispose.call(this)}});Q.prototype=Object.assign(Object.create(B.prototype),{constructor:Q,onLoad:function(a){var b=a.image;this.stereo.updateUniformByFormat(4===b.videoWidth/b.videoHeight?
O.SBS:O.TAB,this.material.uniforms);this.material.uniforms.texture.value=a;B.prototype.onLoad.call(this)},updateTextureToLeft:function(){this.stereo.updateTextureToLeft(this.material.uniforms.offset.value)},updateTextureToRight:function(){this.stereo.updateTextureToRight(this.material.uniforms.offset.value)},dispose:function(){var a=this.material.uniforms.texture.value;a instanceof c.Texture&&a.dispose();B.prototype.dispose.call(this)}});E.prototype=Object.assign(Object.create(l.prototype),{constructor:E,
...
e.type);a(e)}},enableControl:function(){$jscomp.makeIterator(this.controls).next().value.enabled=!0},disableControl:function(){$jscomp.makeIterator(this.controls).next().value.enabled=!1},load:function(){l.prototype.load.call(this,!1);var a=this.readyCallback,b=this.loadedCallback;this.PanoMoments=new wa(this.identifier,this.renderCallback.bind(this),a.bind(this),b.bind(this))},updateHeading:function(){if(this.momentData){var a=(this.momentData.start_frame+180)/180*Math.PI;this.dispatchEvent({type:g.VIEWER_HANDLER,
method:"setControlCenter"});this.dispatchEvent({type:g.VIEWER_HANDLER,method:"rotateControlLeft",data:a})}},getYaw:function(){var a=this.momentData.clockwise,b=c.Math.radToDeg(this.camera.rotation.y)+180;return((a?90:-90)-b)%360},updateCallback:function(){this.momentData&&this.status!==g.PANOMOMENT.NONE&&this.setPanoMomentYaw(this.getYaw())},renderCallback:function(a,b){this.momentData||(this.momentData=b,a=new c.Texture(a),a.minFilter=a.magFilter=c.LinearFilter,a.generateMipmaps=!1,a.format=c.RGBFormat,
this.updateTexture(a),this.dispatchEvent({type:g.PANOMOMENT.FIRST_FRAME_DECODED}),l.prototype.onLoad.call(this))},readyCallback:function(){this.dispatchEvent({type:g.PANOMOMENT.READY})},loadedCallback:function(){this.dispatchEvent({type:g.PANOMOMENT.COMPLETED})},setPanoMomentYaw:function(a){var b=this.status,e=this.momentData,c=this.PanoMoments,d=c.render,k=c.frameCount;c=c.textureReady;c()&&(this.getTexture().needsUpdate=!0);b!==g.PANOMOMENT.READY&&b!==g.PANOMOMENT.COMPLETED||!e||d(a/360*k)},enter:function(){this.updateHeading();
this.addEventListener(g.WIDNOW_RESIZE,this.handlerWindowResize);this.dispatchEvent({type:g.VIEWER_HANDLER,method:"addUpdateCallback",data:this.handlerUpdateCallback})},leave:function(){var a=this.camera,b=$jscomp.makeIterator(this.controls).next().value,c=this.defaults,d=c.fov;Object.assign(b,{minPolarAngle:c.minPolarAngle,maxPolarAngle:c.maxPolarAngle});a.fov=d;a.updateProjectionMatrix();this.removeEventListener(g.WIDNOW_RESIZE,this.handlerWindowResize);this.dispatchEvent({type:g.VIEWER_HANDLER,
method:"removeUpdateCallback",data:this.handlerUpdateCallback})},dispose:function(){this.leave();this.PanoMoments.dispose();this.defaults=this.controls=this.camera=this.container=this.momentData=this.PanoMoments=null;l.prototype.dispose.call(this)}});Y.prototype=Object.assign(Object.create(E.prototype),{constructor:Y,onWindowResize:function(){this.resetControlLimits(!1)},attachFOVListener:function(a){a=void 0===a?!0:a;var b=$jscomp.makeIterator(this.controls).next().value;a?b.addEventListener("fov",
this.viewerResetControlLimits):b.removeEventListener("fov",this.viewerResetControlLimits)},updateHeading:function(){this.momentData&&(this.material.uniforms.offset.value.x=(this.momentData.max_horizontal_fov/360+.25)%1,this.resetControlLimits(!1),E.prototype.updateHeading.call(this))},resetAzimuthAngleLimits:function(a){a=void 0===a?!1:a;var b=$jscomp.makeIterator(this.controls).next().value,e=this.momentData,d=this.defaults,g=d.minPolarAngle;d=d.maxPolarAngle;if(e.contains_parallax||a)e=c.Math.degToRad((.95*
e.min_vertical_fov-this.camera.fov)/2),e={minPolarAngle:Math.PI/2-e,maxPolarAngle:Math.PI/2+e},Object.assign(b,a?{minPolarAngle:g,maxPolarAngle:d}:e)},calculateFOV:function(a,b){var c=this.camera.aspect;return 2*Math.atan(Math.tan(a*Math.PI/360)*(b?c:1/c))/Math.PI*180},resetFOVLimits:function(a){a=void 0===a?!1:a;var b=this.momentData,c=this.camera,d=$jscomp.makeIterator(this.controls).next().value,g=this.defaults.fov,k=this.calculateFOV(c.fov,!0);k>.95*b.min_horizontal_fov?c.fov=this.calculateFOV(.95*
b.min_horizontal_fov,!1):k<d.minFov&&(c.fov=this.calculateFOV(d.minFov,!1));c.fov=a?g:c.fov;c.updateProjectionMatrix()},resetControlLimits:function(a){a=void 0===a?!1:a;this.momentData&&(this.resetFOVLimits(a),this.resetAzimuthAngleLimits(a))},enter:function(){this.attachFOVListener(!0);this.resetControlLimits(!1);E.prototype.enter.call(this)},leave:function(){this.attachFOVListener(!1);this.resetControlLimits(!0);E.prototype.leave.call(this)}});var Ca={texture:{value:new c.Texture},repeat:{value:new c.Vector2(1,
1)},offset:{value:new c.Vector2(0,0)},opacity:{value:1}};ma.prototype=Object.assign(Object.create(E.prototype),{constructor:ma,onWindowResize:function(){this.update2DGeometryScale(!1)},createGeometry:function(){return new c.PlaneBufferGeometry(1,1)},createMaterial:function(a,b){a=void 0===a?new c.Vector2(1,1):a;b=void 0===b?new c.Vector2(0,0):b;var e=c.UniformsUtils.clone(Ca);e.repeat.value.copy(a);e.offset.value.copy(b);e.opacity.value=0;return new c.ShaderMaterial({fragmentShader:"\n         uniform sampler2D texture;\n         uniform vec2 repeat;\n         uniform vec2 offset;\n         uniform float opacity;\n         varying vec2 vUv;\n         \n         void main() {\n             vec2 sampleUV = vUv;\n             sampleUV = sampleUV * repeat + offset;\n         \n             gl_FragColor = texture2D( texture, sampleUV );\n             gl_FragColor.a *= opacity;\n         \n         }\n     ",
...
var b=this.camera;b=2*Math.tan(b.fov*Math.PI/360)*Math.min(a,b.aspect);this.scale2D.set(b,b/a);this.geometry.scale(this.scale2D.x,this.scale2D.y,1)}},enter:function(){this.position.set(0,0,-1);this._parent=this.parent;this.camera.add(this);this.update2DGeometryScale();E.prototype.enter.call(this)},leave:function(){this.position.set(0,0,0);this._parent.add(this);delete this._parent;E.prototype.leave.call(this)}});na.prototype=Object.assign(Object.create(c.EventDispatcher.prototype),{constructor:na});
oa.prototype=Object.assign(Object.create(c.EventDispatcher.prototype),{constructor:oa});var Da=function(a){var b=new c.StereoCamera;b.aspect=.5;var e=new c.Vector2;this.setEyeSeparation=function(a){b.eyeSep=a};this.setSize=function(b,c){a.setSize(b,c)};this.render=function(c,d,g){var f=g instanceof P||g instanceof Q;c.updateMatrixWorld();null===d.parent&&d.updateMatrixWorld();f&&this.setEyeSeparation(g.stereo.eyeSep);b.update(d);a.getSize(e);a.autoClear&&a.clear();a.setScissorTest(!0);f&&g.updateTextureToLeft();
a.setScissor(0,0,e.width/2,e.height);a.setViewport(0,0,e.width/2,e.height);a.render(c,b.cameraL);f&&g.updateTextureToRight();a.setScissor(e.width/2,0,e.width/2,e.height);a.setViewport(e.width/2,0,e.width/2,e.height);a.render(c,b.cameraR);a.setScissorTest(!1);f&&g.updateTextureToLeft()}};pa.prototype=Object.assign(Object.create(c.EventDispatcher.prototype),{constructor:pa,setupScene:function(a){return a=void 0===a?new c.Scene:a},setupCamera:function(a,b,e){e=void 0===e?new c.PerspectiveCamera(a,b,
...
d=c.autoRotate,g=c.autoRotateSpeed,k=c.momentum,l=c.rotateSpeed,n=c.dampingFactor,p=c.speedLimit;c=c.horizontalView;b=Object.assign(new na(a,b),{id:"orbit",index:M.ORBIT,noPan:!0,minDistance:1,autoRotate:d,autoRotateSpeed:g,momentum:k,rotateSpeed:l,dampingFactor:n,speedLimit:p});c&&(b.minPolarAngle=Math.PI/2,b.maxPolarAngle=Math.PI/2);a=Object.assign(new oa(a),{id:"device-orientation",index:M.DEVICEORIENTATION,enabled:!1});this.controls=[b,a];this.OrbitControls=b;this.DeviceOrientationControls=a;
return b},setupEffects:function(a,b){var c=b.clientWidth;b=b.clientHeight;var d=new ya(a);d.setSize(c,b);a=new Da(a);a.setSize(c,b);this.CardboardEffect=d;this.StereoEffect=a;return d},setupContainer:function(a){if(a)return a._width=a.clientWidth,a._height=a.clientHeight,a;a=document.createElement("div");a.classList.add(g.CONTAINER);a.style.width="100%";a.style.height="100%";document.body.appendChild(a);return a},setupTween:function(){this.tweenCanvasOpacityOut.to({},500).easing(t.Easing.Exponential.Out);
this.tweenCanvasOpacityIn.to({},500).easing(t.Easing.Exponential.Out);this.tweenCanvasOpacityOut.chain(this.tweenCanvasOpacityIn)},add:function(a){var b=this.container,c=this.scene,d=this.camera,k=this.controls,n=this.options.initialLookAt;if(1<arguments.length){for(b=0;b<arguments.length;b++)this.add(arguments[b]);return this}c.add(a);a.addEventListener&&a.addEventListener(g.VIEWER_HANDLER,this.eventHandler.bind(this));a instanceof l&&(a.dispatchEvent({type:g.CONTAINER,container:b}),a.dispatchEvent({type:"panolens-scene",
scene:c}),a.dispatchEvent({type:g.CAMERA,camera:d}),a.dispatchEvent({type:g.CONTROLS,controls:k}),this.addPanoramaEventListener(a),this.panorama||(this.setPanorama(a),this.setControlCenter(n)))},remove:function(a){a.removeEventListener&&a.removeEventListener(g.VIEWER_HANDLER,this.eventHandler.bind(this));this.scene.remove(a)},addDefaultControlBar:function(a){if(this.widget)console.warn("Default control bar exists");else{var b=new S(this.container);b.addEventListener(g.VIEWER_HANDLER,this.eventHandler.bind(this));
b.addControlBar();a.forEach(function(a){b.addControlButton(a)});this.widget=b}},setPanorama:function(a){var b=this.panorama;if(a instanceof l&&b!==a){this.hideInfospot();if(b){if(a instanceof E){var c=function(){b.removeEventListener(g.LEAVE_COMPLETE,c);delete b._onLeaveComplete;a.active&&a.loaded&&a.fadeIn()};b._onLeaveComplete=c;b.addEventListener(g.LEAVE_COMPLETE,c)}b._onReady&&(b.removeEventListener(g.READY,b._onReady),delete b._onReady);b._onEnterFadeStart&&(b.removeEventListener(g.ENTER_FADE_START,
b._onEnterFadeStart),delete b._onEnterFadeStart)}a._onLeaveComplete&&(a.removeEventListener(g.LEAVE_COMPLETE,a._onLeaveComplete),delete a._onLeaveComplete);var d=function(){a.removeEventListener(g.READY,d);delete a._onReady;a.active&&(a instanceof E?(!b||b&&!b._onLeaveComplete)&&a.fadeIn():a.fadeIn())},k=function(){if(b)b.onLeave();a.removeEventListener(g.ENTER_FADE_START,k);delete a._onEnterFadeStart};a.addEventListener(g.READY,d);a.addEventListener(g.ENTER_FADE_START,k);a._onReady=d;a._onEnterFadeStart=
k;this.panorama=a;requestAnimationFrame(function(){return a.onEnter()})}},eventHandler:function(a){if(a.method&&this[a.method])this[a.method](a.data)},dispatchEventToChildren:function(a){this.scene.traverse(function(b){b.dispatchEvent&&b.dispatchEvent(a)})},activateWidgetItem:function(a,b){var c=this.widget.mainMenu,d=c.children[0];c=c.children[1];if(void 0!==a){switch(a){case 0:a=d.subMenu.children[1];break;case 1:a=d.subMenu.children[2];break;default:a=d.subMenu.children[1]}d.subMenu.setActiveItem(a);
d.setSelectionTitle(a.textContent)}if(void 0!==b){switch(b){case y.CARDBOARD:a=c.subMenu.children[2];break;case y.STEREO:a=c.subMenu.children[3];break;default:a=c.subMenu.children[1]}c.subMenu.setActiveItem(a);c.setSelectionTitle(a.textContent)}},enableEffect:function(a){if(this.mode!==a)if(a===y.NORMAL)this.disableEffect();else{this.mode=a;var b=this.camera.fov;switch(a){case y.CARDBOARD:this.effect=this.CardboardEffect;this.enableReticleControl();break;case y.STEREO:this.effect=this.StereoEffect;
this.enableReticleControl();break;default:this.effect=null,this.disableReticleControl()}this.activateWidgetItem(void 0,this.mode);this.dispatchEventToChildren({type:"panolens-dual-eye-effect",mode:this.mode});this.camera.fov=b+.01;this.effect.setSize(this.container.clientWidth,this.container.clientHeight);this.render();this.camera.fov=b;this.dispatchEvent({type:g.MODE_CHANGE,mode:this.mode})}},disableEffect:function(){this.mode!==y.NORMAL&&(this.mode=y.NORMAL,this.disableReticleControl(),this.activateWidgetItem(void 0,
...
return{left:d,up:b}},setControlCenter:function(a){a=void 0===a?this.options.initialLookAt:a;a=this.calculateCameraDirectionDelta(a);this.rotateOrbitControl(a.left,a.up)},tweenControlCenter:function(a,b,c){a instanceof Array&&(c=a[2],b=a[1],a=a[0]);b=void 0!==b?b:1E3;c=c||t.Easing.Exponential.Out;var e=this.calculateCameraDirectionDelta(a);a=e.left;e=e.up;var d=this.rotateControlLeft.bind(this),g=this.rotateControlUp.bind(this),k={left:0,up:0},l=0,n=0;this.tweenLeftAnimation.stop();this.tweenUpAnimation.stop();
this.tweenLeftAnimation=(new t.Tween(k)).to({left:a},b).easing(c).onUpdate(function(a){var b=a.left-l;1E-4>Math.abs(b)&&this.tweenLeftAnimation.stop();d(b);l=a.left}.bind(this)).start();this.tweenUpAnimation=(new t.Tween(k)).to({up:e},b).easing(c).onUpdate(function(a){var b=a.up-n;1E-4>Math.abs(b)&&this.tweenUpAnimation.stop();g(b);n=a.up}.bind(this)).start()},tweenControlCenterByObject:function(a,b,e){this.tweenControlCenter(a.getWorldPosition(new c.Vector3),b,e)},onWindowResize:function(a,b){var c=
...
!0);window.removeEventListener("keydown",this.handlerKeyDown,!0);window.removeEventListener("keyup",this.handlerKeyUp,!0)},dispose:function(){function a(b){for(var c=b.children.length-1;0<=c;c--)a(b.children[c]),b.remove(b.children[c]);b instanceof l||b instanceof u?b.dispose():b.dispatchEvent&&b.dispatchEvent("dispose")}this.disableAutoRate();this.tweenLeftAnimation.stop();this.tweenUpAnimation.stop();this.unregisterEventListeners();a(this.scene);this.widget&&(this.widget.dispose(),this.widget=null);
c.Cache&&c.Cache.enabled&&c.Cache.clear()},destroy:function(){this.dispose();this.render();window.cancelAnimationFrame(this.requestAnimationId)},onPanoramaDispose:function(a){var b=this.scene,c=function(b){return b.toPanorama!==a?b:b.dispose()};a instanceof B&&this.hideVideoWidget();b.traverse(function(a){a instanceof l&&(a.linkedSpots=a.linkedSpots.map(c).filter(function(a){return!!a}))});a===this.panorama&&(this.panorama=null)},loadAsyncRequest:function(a,b){b=void 0===b?function(){}:b;var c=new window.XMLHttpRequest;
c.onloadend=function(a){b(a)};c.open("GET",a,!0);c.send(null)},addViewIndicator:function(){var a=this;this.loadAsyncRequest(A.ViewIndicator,function(b){if(0!==b.loaded){b=b.target.responseXML.documentElement;b.style.width=a.viewIndicatorSize+"px";b.style.height=a.viewIndicatorSize+"px";b.style.position="absolute";b.style.top="10px";b.style.left="10px";b.style.opacity="0.5";b.style.cursor="pointer";b.id="panolens-view-indicator-container";a.container.appendChild(b);var d=b.querySelector("#indicator");
...
g=Array.prototype.slice.call(b.children);d.includes(a)&&c.removeChild(a);g.includes(a)&&b.removeChild(a)},clearAllCache:function(){c.Cache.clear()}});"117"!=c.REVISION&&console.warn("three.js version is not matched. Please consider use the target revision 117");window.TWEEN=t;d.BasicPanorama=ea;d.CONTROLS=M;d.CameraPanorama=X;d.CubePanorama=U;d.CubeTextureLoader=ta;d.DataImage=A;d.EVENTS=g;d.EmptyPanorama=K;d.GoogleStreetviewPanorama=da;d.ImageLittlePlanet=aa;d.ImageLoader=qa;d.ImagePanorama=k;d.Infospot=
u;d.LittlePlanet=H;d.MODES=y;d.Media=n;d.PanoMoment=E;d.PanoMomentPanorama=Y;d.PanoMomentRegular=ma;d.Panorama=l;d.REVISION="13";d.Reticle=p;d.STEREOFORMAT=O;d.Stereo=v;d.StereoImagePanorama=P;d.StereoVideoPanorama=Q;d.THREE_REVISION="117";d.THREE_VERSION=za;d.TextureLoader=Z;d.VERSION="0.13.0";d.VideoPanorama=B;d.Viewer=pa;d.Widget=S;Object.defineProperty(d,"__esModule",{value:!0})});
