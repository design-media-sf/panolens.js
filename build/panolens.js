(function (global, factory) {
	...
	PanoMomentPanorama.prototype = Object.assign(
	  Object.create(PanoMoment.prototype),
	  {
	    ...
	    resetAzimuthAngleLimits: function (reset = false) {
	      ...
	      const delta = THREE.Math.degToRad(
	...
	function CardboardEffect(renderer) {
	  ...
	  const geometry = new THREE.PlaneBufferGeometry(1, 1, 10, 20)
	...
	Viewer.prototype = Object.assign(
	  Object.create(THREE.EventDispatcher.prototype),
	  {
	    ...
	    setupCamera: function (
	      cameraFov,
	      ratio,
	      camera = new THREE.PerspectiveCamera(cameraFov, ratio, 1, 10000)
	    ) {
